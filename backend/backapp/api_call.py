...
def get_recipe(weight, ingredients):
    ...
    weight + "weight and keept it short and simple with nothing unnecesary. Return the nutritional facts at the end and what to do with the waste produced very briefly")
